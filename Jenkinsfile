node ('master'){
   ...
   sh "${mvnHome}/bin/mvn package sonar:sonar -Dsonar.host.url=http://192.168.0.42:9000"

   input "Does http://192.168.0.42:9000/dashboard/index/io.dropwizard:dropwizard-example look good?"
